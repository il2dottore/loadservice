...
import { Feature, Plans } from '@modules/admin/feature/enums/feature.enum';
...
import { ticketsTable, TicketStatus, type TicketStatusValue } from '@modules/ticket/schemas/ticket.schema';
